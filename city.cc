...
int find_min_cost(map<int, ListNode *> &city_map, int first, int last, int min_cost) {
...
int find_min(map<int, ListNode *> &city_map, int N) {
    int first = 1;
    int last = N;
